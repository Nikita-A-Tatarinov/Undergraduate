...
void my_handler(int nsig) {
  int status;
  pid_t pid;
  //Так как сигналы одного типа в очередь не становятся, 
  //ожидаем все сигналы внутри первого вызванного метода.
  ...
  //Если ошибок не произойдёт, данная строка не будет достигнута.
